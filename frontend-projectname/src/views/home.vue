  ...
  methods: {
    ...
    addEles() {
      this.$refs["ref_CJS"].addEles([
        ...
        {
          group: "edges",
          data: { id: "e0", name: "is", source: "张三", target: "学生" },
          classes: "relationA",
        },
        {
          group: "edges",
          data: { id: "e1", name: "is", source: "张三", target: "男性" },
          classes: "relationA",
        },
        {
          group: "edges",
          data: { id: "e2", name: "like", source: "张三", target: "游戏" },
          classes: "relationA",
        },
        {
          group: "edges",
          data: { id: "e3", name: "like", source: "张三", target: "甜点" },
          classes: "relationA",
        },
        {
          group: "edges",
          data: { id: "e4", name: "like", source: "张三", target: "干饭" },
          classes: "relationA",
        },
        {
          group: "edges",
          data: { id: "e5", name: "like", source: "男性", target: "游戏" },
          classes: "relationA",
        },
        {
          group: "edges",
          data: { id: "e6", name: "like", source: "男性", target: "代码" },
          classes: "relationA",
        },
      ]);
    },
